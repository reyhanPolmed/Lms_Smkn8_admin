                    ...
                    <table class="w-full text-xs">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-200 transition">
                                ...
                                <td class="px-4 py-3">
                                    {{-- Menggunakan relasi homeroomTeacher (CamelCase) sesuai model di snippet kedua --}}
                                    @if($class->homeroomTeacher)
                                    <div class="flex items-center gap-2">
                                        <img src="{{ $record->headOfDepartment->foto ? url('/file/' . $record->headOfDepartment->foto) : '/placeholder.svg' }}" class="w-8 h-8 rounded-full object-cover">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center justify-center gap-1">
                                        {{-- Actions tetap menggunakan SVG dari desain pertama --}}
